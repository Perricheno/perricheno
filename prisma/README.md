...
- В корне репозитория дополнительно лежат **устаревшие** SQL-файлы (`../migrations/`, `../supabase/migrations/`), описывающие другую, несовместимую схему — см. их отдельные README и [`../docs/REVIEW.md`](../docs/REVIEW.md), пункт 10.
