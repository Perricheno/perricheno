...
- `checkServiceHealth('openai')` дергает `https://api.openai.com/v1/models` — согласуется с реальным провайдером LLM всего проекта (OpenAI, модель `gpt-5-mini-2025-08-07`, см. [`docs/integrations.md`](../../../../docs/integrations.md), раздел 4), не мёртвая проверка.
