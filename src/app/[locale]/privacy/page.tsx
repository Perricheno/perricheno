...
export default function PrivacyPage() {
    const contentEn = fs.readFileSync(path.join(process.cwd(), "src/content/privacy_en.md"), "utf8");
    const contentRu = fs.readFileSync(path.join(process.cwd(), "src/content/privacy_ru.md"), "utf8");
        ...
        <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] selection:bg-black selection:text-white">
            <div className="max-w-7xl mx-auto px-6 py-12 md:py-24">
                ...
                <header className="mb-24">
                    <h1 className="text-6xl md:text-8xl font-bold tracking-tighter mb-4">Privacy Policy.</h1>
                    <p className="text-xl md:text-2xl font-light opacity-40">Privacy & Data Protection for Perricheno Inc. platforms.</p>
                </header>
                ...
                <footer className="mt-40 pt-12 border-t border-[var(--border)] flex flex-col md:flex-row justify-between items-center gap-8 opacity-30 text-[11px] uppercase tracking-widest font-bold">
                    <p>© 2026 Perricheno Inc. • ALL RIGHTS RESERVED</p>
