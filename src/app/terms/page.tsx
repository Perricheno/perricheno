        ...
        <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] selection:bg-black selection:text-white">
            <div className="max-w-7xl mx-auto px-6 py-12 md:py-24">
                ...
                <header className="mb-24">
                    <h1 className="text-6xl md:text-8xl font-bold tracking-tighter mb-4">Terms of Service.</h1>
                    <p className="text-xl md:text-2xl font-light opacity-40">User Agreement for Perricheno Inc. platforms.</p>
                </header>
