                                ...
                                <div className="flex items-start gap-2">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className={`flex items-center gap-2 text-[11px] mt-1 ${isActive ? 'text-[var(--card)] opacity-70' : 'text-gray-400'}`}>
                                            ...
                                            }`}>{s.doc_type === 'chat' ? 'Chat' : s.doc_type === 'literature_search' ? 'Scholar' : (s.doc_type === 'data_analytics' || s.doc_type === 'data-analytics') ? 'Agent' : 'Report'}</span>
