                        ...
                        {items.map((item, idx) => (
                            ...
                            >
                                <Link
                                    href={item.href}
                                    key={item.title}
                                    className="h-10 w-10 rounded-full bg-neutral-900 flex items-center justify-center border border-neutral-200 text-neutral-500 font-medium hover:text-neutral-900 transition-colors"
                                >
